	...
	<div class="left-sidebar-pro">
		<nav id="sidebar" class="">
			<div class="sidebar-header">
				...
				<a href="index-2.html"><img class="main-logo"
					src="img/logo/LOGO_TTY_LTWEB.png" height="205" width="150"
