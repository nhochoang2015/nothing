        ...
        <div class="row">
                ...
                <div class="leaderboard-card leaderboard-card-second">
                    ...
                    <div class="leaderboard-card__body">
                        <div class="text-center">
                            <img src="ranking/ranking/img/user2.jpg" class="circle-img mb-2" alt="User Img">
            ...
            <div class="col-sm-4">
                <div class="leaderboard-card leaderboard-card-first">
                    <div class="leaderboard-card__top">
                        <h3 class="text-center">Điểm</h3>
                    </div>
                    <div class="leaderboard-card__body">
                        <div class="text-center">
                            <img src="ranking/img/user1.jpg" class="circle-img mb-2" alt="User Img">
                            <h5 class="mb-0">Tên</h5>
                            <hr>
                            <div class="d-flex justify-content-between align-items-center">
                                <button class="btn btn-outline-success btn-sm">Chúc mừng</button>
            ...
            <div class="col-sm-4">
                <div class="leaderboard-card leaderboard-card-third">
                    ...
                    <div class="leaderboard-card__body">
                        <div class="text-center">
                            <img src="ranking/img/user3.jpg" class="circle-img mb-2" alt="User Img">
                            <h5 class="mb-0">Tên</h5>
                            <hr>
                            <div class="d-flex justify-content-between align-items-center">
                                <button class="btn btn-outline-success btn-sm">Chúc mừng</button>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <img src="ranking/img/user1.jpg" class="circle-img circle-img--small mr-2" alt="User Img">
