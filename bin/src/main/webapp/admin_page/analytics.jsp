							...
							<div class="income-dashone-pro">
								<div class="income-rate-total">
									<div class="price-adminpro-rate">
										<h3>
											<span>$</span><span class="counter">7500</span>
										</h3>
									</div>
								...
								<div class="income-range">
									<p>Tổng thu nhập</p>
									<!--                                    <p>Total income</p>-->
									<span class="income-percentange bg-green"><span
										class="counter">95</span>% <i class="fa fa-bolt"></i> </span>
								</div>
								<div class="clear"></div>
							</div>
						</div>
						...
						<div class="income-dashone-total reso-mg-b-30">
							<div class="income-dashone-pro">
								...
								<div class="income-range order-cl">
									<p>Đơn hàng mới</p>
									<!--                                    <p>New Orders</p>-->
									<span class="income-percentange bg-red"><span
										class="counter">65</span>% <i class="fa fa-level-up"></i> </span>
								</div>
								<div class="clear"></div>
							</div>
						</div>
						...
						<div class="income-dashone-total reso-mg-b-30 res-mg-t-30">
							<div class="income-dashone-pro">
								...
								<div class="income-range visitor-cl">
									<p>Khách truy cập mới</p>
									<!--                                    <p>New Visitor</p>-->
									<span class="income-percentange bg-blue"><span
										class="counter">75</span>% <i class="fa fa-level-up"></i> </span>
								</div>
								<div class="clear"></div>
							</div>
						</div>
						...
						<div class="income-dashone-total res-mg-t-30">
							<div class="income-dashone-pro">
								<div class="income-rate-total">
									<div class="price-adminpro-rate">
										<h3>
											<span class="counter">235400</span>
										</h3>
									</div>
									<div class="price-graph">
								...
								<div class="income-range low-value-cl">
									<p>Trong tháng đầu tiên</p>
									<!--                                    <p>In first month</p>-->
									<span class="income-percentange bg-purple"><span
										class="counter">35</span>% <i class="fa fa-level-down"></i> </span>
								</div>
								<div class="clear"></div>
							</div>
						</div>
